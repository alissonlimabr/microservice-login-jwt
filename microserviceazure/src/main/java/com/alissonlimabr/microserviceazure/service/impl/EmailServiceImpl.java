...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendPasswordResetEmail(String recipient, String token) throws MessagingException {
        ...
        String text = "<html>"
                ...
                +
                "<p style='background-color: #24a0ed; padding: 10px; color: white; border-radius: 5px; display: inline-block;'><a href='https://loginjwt.alissonlimadev.com/reset/"
                + recipient + "/"
                ...
                "<p>Alisson Lima.</p>"
                +
                "<span style='background-color: #0e76a8 ; padding: 10px; color: white; border-radius: 5px; display: inline-block;'><a href='https://www.linkedin.com/in/alissonlimadev/' style='color: white; text-decoration: none;'>LinkedIn</a></span>  "
                +
